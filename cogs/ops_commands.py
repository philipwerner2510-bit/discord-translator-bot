...
BOT_COLOR = 0xDE002A
# TEMP: use libretranslate.de (your env was failing DNS to argosopentech)
LIBRE_BASE = os.getenv("LIBRE_BASE", "https://libretranslate.de")
        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get(
                    LIBRE_LANG_URL, headers={"Accept": "application/json"}, timeout=12, allow_redirects=True
                ) as resp:
