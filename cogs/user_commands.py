...
class UserCommands(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(title="📖 Demon Translator Help", description="List of available commands", color=0xDE002A)
        embed.add_field(
            name="/setmylang `<lang>`",
        ...
        if is_admin:
            ...
            embed.add_field(name="/defaultlang `<lang>`", value="Set the default translation language for the server.", inline=False)
            ...
            embed.add_field(name="/langlist", value="Show all supported language codes.", inline=False)
